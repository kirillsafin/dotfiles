  ...
  config = function()
    ...
    dap.adapters.python = function(callback, config)
      if config.request == 'attach' then
        callback({
          type = 'server',
          port = assert(config.connect.port or config.port,
    ...
    keymap.set("n", "<leader>dPa", function() dap.set_exception_breakpoints({ "all" }) end,
      { desc = "Set all exception breakpoints", noremap = true })
    keymap.set("n", "<leader>dPb", function() dap.set_exception_breakpoints(vim.fn.input("Breakpoint condition: ")) end,
      { desc = "Set exception breakpoint with condition", noremap = true })
    keymap.set("n", "<leader>dPc",
      function() dap.set_exception_breakpoints(nil, nil, vim.fn.input("Log point message: ")) end,
      { desc = "Set log point", noremap = true })

    keymap.set("n", "<S-k>", dap.step_out, { desc = "Step out", noremap = true })
    keymap.set("n", "<S-l>", dap.step_into, { desc = "Step into", noremap = true })
    keymap.set("n", "<S-j>", dap.step_over, { desc = "Step over", noremap = true })
    keymap.set("n", "<S-h>", dap.continue, { desc = "Continue", noremap = true })
    ...
    keymap.set("n", "<leader>dD", function() dap.disconnect({ restart = false, terminateDebugee = false }) end,
      { desc = "Disconnect and keep", noremap = true })
    ...
    keymap.set("n", "<leader>dcc", function()
      ...
      { desc = "Center and frames", noremap = true })
