return {
  ...
  opts = {
    cmd =
    "NODE_OPTIONS=--experimental-vm-modules TEST_POSTGRES_HOST=127.0.0.1 TEST_POSTGRES_PORT=5432 TEST_POSTGRES_USER=postgres TEST_POSTGRES_PASSWORD=password TEST_POSTGRES_DB=nest_db TEST_CLUSTER_NAME=cluster-1 SALT_MASTER_TEST_URL=test.com SALT_MASTER_TEST_USER=user SALT_MASTER_TEST_PWD=test node ./node_modules/jest/bin/jest.js --detectOpenHandles -t \"$result\" $file", -- run command
